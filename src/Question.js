   ...
   const  [isRight,setIsRight] =useState(false)
    ...
    const Select =(text,totalCorrect)=>{
        ...
        console.log(text)
          ...
          if(text==decodeURI(question[index].correct_answer)){
            ...
            setCorrect(`Wrong! Correct answer is ${decodeURIComponent(question[index].correct_answer)}`)
          }
     ...
     newscore =totalCorrect/(index+1)
      ...
      var maxscore= (totalCorrect+ (question.length-index))/question.length
    ...
    return (
        ...
        <div   className="quiz_box">
        {
            ...
            <Typography  variant={'h5'}   >{`Question  ${index+1}  of  ${question.length+1}`}</Typography>
           ...
           question[index].difficulty=="hard" &&
              <div>
                ...
                <StarIcon  style={{color:index<3 && "green"  }}     />
              ))
                }
              </div>
           ...
           question[index].difficulty=="easy" &&
            ...
            <Grid container >   
            {
              ...
              {
                index <question.length-1 && <Box mt={2}  > <Button color="primary" disableElevation  variant="contained"  disabled={Nextdisable} onClick={NextQuestion}>Next</Button> </Box>
              }  
        </div>
